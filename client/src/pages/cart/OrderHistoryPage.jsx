...
export default function OrderHistoryPage() {
  ...
  const userId = 1; // sau này thay bằng ID từ token
  ...
  return (
    <div className="w-full bg-gray-100 py-10">
      <div className="max-w-7xl mx-auto bg-white p-8 rounded-2xl shadow-sm">
            ...
            <tbody>
              {orders.map((order) => (
                <tr key={order.id} className="border-b hover:bg-gray-50">
                  ...
                  {/* Payment */}
                  <td className="py-3 px-4 text-gray-700">{order.payment_method}</td>
        ...
        {/* Pagination (hiện tại giữ nguyên UI mẫu) */}
        <div className="flex justify-between items-center mt-6 text-gray-700">
          <p>{orders.length} đơn • Trang 1/1</p>
